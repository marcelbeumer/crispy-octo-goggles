...
func (ec *executionContext) _Entity_findProductBySku(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNProduct2ᚖgithubᚗcomᚋmarcelbeumerᚋgoᚑplaygroundᚋbasicᚑgraphqlᚑfederationᚋservicesᚋcommerceᚋgraphᚋmodelᚐProduct(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_product(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Product)
	fc.Result = res
	return ec.marshalOProduct2ᚖgithubᚗcomᚋmarcelbeumerᚋgoᚑplaygroundᚋbasicᚑgraphqlᚑfederationᚋservicesᚋcommerceᚋgraphᚋmodelᚐProduct(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNProduct2githubᚗcomᚋmarcelbeumerᚋgoᚑplaygroundᚋbasicᚑgraphqlᚑfederationᚋservicesᚋcommerceᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v model.Product) graphql.Marshaler {
	return ec._Product(ctx, sel, &v)
}

func (ec *executionContext) marshalNProduct2ᚖgithubᚗcomᚋmarcelbeumerᚋgoᚑplaygroundᚋbasicᚑgraphqlᚑfederationᚋservicesᚋcommerceᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v *model.Product) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOProduct2ᚖgithubᚗcomᚋmarcelbeumerᚋgoᚑplaygroundᚋbasicᚑgraphqlᚑfederationᚋservicesᚋcommerceᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v *model.Product) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Product(ctx, sel, v)
